  ...
  return (
    <div className="step_cotizacion">
      ...
      <ol>
        ...
        <li>
          Para validar esta información y confirmar los detalles, por favor contacte a un asesor comercial de <strong>DGASA.com®</strong> a través de nuestros canales autorizados o mediante el botón de contacto disponible en nuestra página web.
        </li>
      </ol>
